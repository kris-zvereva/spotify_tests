...
class PlaylistClient(SpotifyBaseClient):
    ...
    def add_items_to_playlist(self, playlist_id: str, track_ids: list) -> bool:
        """
        Add tracks to playlist
        Args:
            playlist_id: Playlist ID
            track_ids: List of track IDs
        Returns: True if items were added, False if not
        """
    ...
    def get_playlist_items(self, playlist_id: str) -> list:
        ...
        allure.attach(str(len(track_ids)), "Tracks count", allure.attachment_type.TEXT)
